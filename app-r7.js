...
const dom = {
  ...
  atlasSelected: document.getElementById("atlas-selected"),
...
const regionDefs = [
  {
    ...
    peakMs: 30,
    widthMs: 13,
    s2: { normal: 0.45, impaired: 0.93 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "MD (Thalamus, mediodorsal Nucleus)",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_MD_THALAMUS_MEDIODORSAL_NUCLEUS",
      short: "MD",
      aliases: ["thalamus", "mediodorsal nucleus", "md"]
    }
  },
  {
    id: "stgL",
    ...
    peakMs: 55,
    widthMs: 18,
    s2: { normal: 0.34, impaired: 0.87 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area Te 3 (STG) left",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_TE_3_STG_LEFT",
      short: "Te3-L",
      aliases: ["stg left", "te3 left", "superior temporal gyrus left", "area te 3"]
    }
  },
  {
    id: "stgR",
    ...
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area Te 3 (STG) right",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_TE_3_STG_RIGHT",
      short: "Te3-R",
      aliases: ["stg right", "te3 right", "superior temporal gyrus right", "area te 3"]
    }
  },
  {
    id: "dlpfcL",
    ...
    peakMs: 118,
    widthMs: 35,
    s2: { normal: 0.52, impaired: 0.94 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area 8v1 (MFG) left",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_8V1_MFG_LEFT",
      short: "8v1-L",
      aliases: ["dlpfc left", "mfg left", "area 8v1", "middle frontal gyrus left"]
    }
  },
  {
    id: "dlpfcR",
    ...
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area 8v1 (MFG) right",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_8V1_MFG_RIGHT",
      short: "8v1-R",
      aliases: ["dlpfc right", "mfg right", "area 8v1", "middle frontal gyrus right"]
    }
  },
  {
    id: "acc",
    ...
    peakMs: 128,
    widthMs: 35,
    s2: { normal: 0.55, impaired: 0.9 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area p32 (pACC)",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_P32_PACC",
      short: "p32",
      aliases: ["acc", "anterior cingulate", "pacc", "p32"]
    }
  },
  {
    id: "insulaL",
    ...
    peakMs: 110,
    widthMs: 32,
    s2: { normal: 0.5, impaired: 0.93 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area Id1 (Insula) left",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_ID1_INSULA_LEFT",
      short: "Id1-L",
      aliases: ["insula left", "id1 left", "area id1"]
    }
  },
  {
    id: "insulaR",
    ...
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Area Id1 (Insula) right",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_AREA_ID1_INSULA_RIGHT",
      short: "Id1-R",
      aliases: ["insula right", "id1 right", "area id1"]
    }
  },
  {
    id: "claustrumL",
    ...
    peakMs: 132,
    widthMs: 30,
    s2: { normal: 0.48, impaired: 0.9 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "CL (Thalamus, anterior intralaminar nuclei) left",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_CL_THALAMUS_ANTERIOR_INTRALAMINAR_NUCLEI_LEFT",
      short: "CL-L",
      aliases: ["claustrum left", "cl left", "anterior intralaminar nuclei left"],
      note: "Julich v3.1 proxy mapping for claustrum node"
    }
  },
  {
    id: "claustrumR",
    name: "Claustrum Right",
    peakMs: 132,
    widthMs: 30,
    s2: { normal: 0.48, impaired: 0.9 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "CL (Thalamus, anterior intralaminar nuclei) right",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_CL_THALAMUS_ANTERIOR_INTRALAMINAR_NUCLEI_RIGHT",
      short: "CL-R",
      aliases: ["claustrum right", "cl right", "anterior intralaminar nuclei right"],
      note: "Julich v3.1 proxy mapping for claustrum node"
    }
  },
  {
    ...
    peakMs: 250,
    widthMs: 46,
    s2: { normal: 0.3, impaired: 0.83 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "CA3 (Hippocampus) left",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_CA3_HIPPOCAMPUS_LEFT",
      short: "CA3-L",
      aliases: ["hippocampus left", "ca3 left", "ca3"]
    }
  },
  {
    id: "hippoR",
    ...
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "CA3 (Hippocampus) right",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_CA3_HIPPOCAMPUS_RIGHT",
      short: "CA3-R",
      aliases: ["hippocampus right", "ca3 right", "ca3"]
    }
  },
  {
    id: "septum",
    name: "Septal Cholinergic",
    peakMs: 8,
    widthMs: 10,
    s2: { normal: 0.72, impaired: 0.72 },
    atlas: {
      model: "Julich-Brain Cytoarchitectonic Atlas (v3.1)",
      name: "Ch 123 (Basal Forebrain)",
      id: "JULICH_BRAIN_CYTOARCHITECTONIC_ATLAS_V3_1_CH_123_BASAL_FOREBRAIN",
      short: "Ch123",
      aliases: ["septal cholinergic", "basal forebrain", "ch 123", "cholinergic"]
    }
  }
];
...
let atlasSearchInitialized = false;
...
function createThreeEngine(THREE) {
  ...
  for (const def of regionDefs) {
    ...
    const label = makeRegionLabelSprite(THREE, def.name, def.atlas.short);
    label.position.set(0, size + 0.33, 0);
    regionGroup.add(label);

    const pos = regionLayout[def.id];
    regionGroup.position.set(pos[0], pos[1], pos[2]);
    root.add(regionGroup);
    regionMeshes.set(def.id, { group: regionGroup, body, cloud, label });
  }
  ...
  function focusRegion(regionId) {
    const entry = regionMeshes.get(regionId);
    if (!entry) return;
    const p = entry.group.position;
    const yaw = -Math.atan2(p.x, p.z);
    const pitch = clamp(Math.atan2(p.y, Math.sqrt(p.x * p.x + p.z * p.z)) * 0.55, -0.5, 0.5);
    focusTarget = { yaw, pitch };
  }
  ...
  return {
    ...
    tick(cycleMs, intensities) {
      if (focusTarget && !dragging) {
        root.rotation.y = lerpAngle(root.rotation.y, focusTarget.yaw, 0.11);
        root.rotation.x = lerp(root.rotation.x, focusTarget.pitch, 0.11);
        if (Math.abs(shortAngleDiff(root.rotation.y, focusTarget.yaw)) < 0.01 && Math.abs(root.rotation.x - focusTarget.pitch) < 0.01) {
          focusTarget = null;
        }
      } else {
      ...
      for (const [id, mesh] of regionMeshes.entries()) {
        ...
        mesh.label.material.opacity = isSelected ? 1 : 0.76;
        if (isSelected) {
          const pulse = 0.08 + 0.07 * (0.5 + 0.5 * Math.sin(state.simTimeMs / 120));
          mesh.body.material.emissiveIntensity += 0.75;
          mesh.body.material.opacity = Math.min(1, mesh.body.material.opacity + pulse);
          mesh.group.scale.setScalar(mesh.group.scale.x + 0.08);
          mesh.cloud.material.opacity = Math.min(1, mesh.cloud.material.opacity + 0.22);
          mesh.cloud.material.size += 0.02;
        }
      }
...
function initializeAtlasSearch() {
  if (atlasSearchInitialized || !dom.regionSearch || !dom.atlasResults || !dom.atlasSelected) {
    return;
  }
  atlasSearchInitialized = true;

  dom.regionSearch.addEventListener("input", () => {
    renderAtlasSearchResults(dom.regionSearch.value.trim());
  });

  dom.regionSearch.addEventListener("keydown", (event) => {
    if (event.key !== "Enter") return;
    const results = filterAtlasRegions(dom.regionSearch.value.trim());
    if (!results.length) return;
    event.preventDefault();
    selectAtlasRegion(results[0].id, { fillInput: true });
  });

  renderAtlasSearchResults("");
  updateAtlasSelectedPanel();
}

function filterAtlasRegions(query) {
  const needle = query.trim().toLowerCase();
  if (!needle) return regionDefs;
  const tokens = needle.split(/\s+/g).filter(Boolean);
  return regionDefs.filter((def) => {
    const haystack = [
      def.name,
      def.atlas.name,
      def.atlas.id,
...
function renderAtlasSearchResults(query) {
  const results = filterAtlasRegions(query);
  dom.atlasResults.innerHTML = "";

  for (const def of results) {
    const button = document.createElement("button");
    button.type = "button";
    button.className = `atlas-result${def.id === state.selectedRegionId ? " active" : ""}`;
    const note = def.atlas.note ? ` | ${def.atlas.note}` : "";
    button.innerHTML = `<span>${def.atlas.name}</span><small>${def.atlas.id}</small><small>Model Node: ${def.name}${note}</small>`;
    button.addEventListener("click", () => selectAtlasRegion(def.id, { fillInput: true }));
    dom.atlasResults.appendChild(button);
  }

  if (!results.length) {
    const empty = document.createElement("div");
    empty.className = "atlas-selected";
    empty.textContent = "No matching Julich v3.1 region in this model.";
    dom.atlasResults.appendChild(empty);
  }
}

function selectAtlasRegion(regionId, options = {}) {
  const def = regionDefs.find((item) => item.id === regionId);
  if (!def) return;
  state.selectedRegionId = regionId;
  if (options.fillInput) {
    dom.regionSearch.value = def.atlas.name;
  }
  if (engine && typeof engine.focusRegion === "function") {
    engine.focusRegion(regionId);
  }
  updateAtlasSelectedPanel();
  renderAtlasSearchResults(dom.regionSearch.value.trim());
}

function updateAtlasSelectedPanel() {
  if (!dom.atlasSelected) return;
  if (!state.selectedRegionId) {
    dom.atlasSelected.textContent =
      "Selected: none | Atlas: Julich-Brain Cytoarchitectonic Atlas (v3.1)";
    return;
  }
  const def = regionDefs.find((item) => item.id === state.selectedRegionId);
  if (!def) return;
  const note = def.atlas.note ? ` | ${def.atlas.note}` : "";
  dom.atlasSelected.textContent =
    `${def.atlas.name} | ${def.atlas.id}${note}`;
}

function makeRegionLabelSprite(THREE, title, subtitle) {
  ...
  ctx.fillText(title, 165, 38);

  ctx.fillStyle = "#b9b9b9";
  ctx.font = "500 18px 'IBM Plex Mono', monospace";
  ctx.fillText(subtitle, 165, 70);
...
function createFallback2D() {
  ...
  return {
    ...
    tick(cycleMs, intensities) {
      ...
      drawLink(ctx, points.get("thalamus"), points.get("stgL"), w, h);
      drawLink(ctx, points.get("thalamus"), points.get("stgR"), w, h);
      drawLink(ctx, points.get("stgL"), points.get("dlpfcL"), w, h);
      drawLink(ctx, points.get("stgR"), points.get("dlpfcR"), w, h);
      drawLink(ctx, points.get("stgL"), points.get("hippoL"), w, h);
      drawLink(ctx, points.get("stgR"), points.get("hippoR"), w, h);
      drawLink(ctx, points.get("septum"), points.get("hippoL"), w, h);
      drawLink(ctx, points.get("septum"), points.get("hippoR"), w, h);

      for (const [regionId, p] of points.entries()) {
        const active = clamp((intensities.get(regionId) ?? 0) / 1.1, 0, 1);
        const def = regionDefs.find((item) => item.id === regionId);
        drawNode(ctx, def?.atlas?.short ?? def?.name ?? regionId, p[0] * w, p[1] * h, active, regionId === state.selectedRegionId);
      }
...
function drawNode(ctx, label, x, y, activity, isSelected = false) {
  const r = 18 + activity * 14;
  const glow = ctx.createRadialGradient(x, y, r * 0.2, x, y, r * 1.5);
  glow.addColorStop(0, `rgba(255,255,255,${(isSelected ? 0.42 : 0.2) + activity * 0.7})`);
  ...
  ctx.fillStyle = `rgba(${isSelected ? "225,225,225" : "155,155,155"},${0.45 + activity * 0.5})`;
  ctx.strokeStyle = isSelected ? "#ffffff" : "#f0f0f0";
...
function lerpAngle(from, to, alpha) {
  return from + shortAngleDiff(from, to) * alpha;
}
